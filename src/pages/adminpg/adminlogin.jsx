  ...
  const navigate = useNavigate();
    return (
        ...
        <form className='max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg'>
          ...
          <button className='w-full my-5 py-2 bg-teal-500 shadow-lg shadow-teal-500/50 hover:shadow-teal-500/50 text-white font-semibold rounded-lg'onClick={()=> navigate('/dashboard')}>Login</button>
        </form>
      </div>
    </div>
  )
