...
//             Drag and drop a PDF file here or click to choose a file:
//           </label>
//           <input
//             type="file"
//             id="file"
...
//           />
//           <div
//             className={`w-full px-3 py-32 border border-dashed border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
//               file ? "bg-gray-100" : ""
//             }`}
